...
public class Plane {
    ...
    public void transformTo(int tx, int ty, int tz, boolean mirror) {
        for (int i = 0; i < n; i++) {
            ox[i] = mirror ? -ox[i] + tx : ox[i] + tx;
            oy[i] += ty;
            oz[i] += tz;
        }
        loadprojf();
    ...
    public Plane(Medium medium, int ai[], int ai1[], int ai2[], int i, int ai3[], boolean flag,
        ...
        // THIS IS WHERE THE COLOR STUFF IS APPLIED HUGE
        if (!flag) {
            j3 = 0;
            do {
        ...
        if (flag) {
            j3 = 0;
            do {
                c[j3] = (Medium.csky[j3] * Medium.fade[0] * 2 + Medium.cfade[j3] * 3000) / (Medium.fade[0] * 2 + 3000); // this colors the class polys?
            } while (++j3 < 3);
        }
        disline = k1;
        bfase = l1;
    ...
    public void d(Graphics2D rd, int i, int j, int k, int l, int i1, int j1, int k1, int l1, boolean flag, int i2, boolean isHovered, boolean isSelected) {
        ...
        if (embosUndead == 0) {
            ...
            if (embosUndead <= 11 && Medium.random() > 0.5D && !glass) {
                for (int l2 = 0; l2 < n; l2++) {
                    ai[l2] = (int) (ox[l2] + i + (15F - Medium.random() * 30F));
                    ai2[l2] = (int) (oy[l2] + j + (15F - Medium.random() * 30F));
                    ai1[l2] = (int) (oz[l2] + k + (15F - Medium.random() * 30F));
            ...
            float f = 1.0F;
            if (embosUndead <= 4)/// explode outward a little + white flame
            {
                f = 1.0F + Medium.random() / 5F;
            }
            if (embosUndead > 4 && embosUndead <= 7)/// explode outward a little + white flame a bit bigger than previous
            {
                f = 1.0F + Medium.random() / 4F;
            }
            if (embosUndead > 7 && embosUndead <= 9)/////// /// explode outward a little + white flame a bit bigger than previous + polUtility.ys start to darken
            {
                f = 1.0F + Medium.random() / 3F;
                if (hsb[2] > 0.69999999999999996D) {
                    hsb[2] = 0.7F;
            ...
            if (embosUndead > 9 && embosUndead <= 10)/////// /// explode outward a little + white flame a bit bigger than previous + maor darkening
            {
                f = 1.0F + Medium.random() / 2.0F;
                if (hsb[2] > 0.59999999999999998D) {
                    hsb[2] = 0.6F;
            ...
            if (embosUndead > 10 && embosUndead <= 12)/////// /// explode outward a little + white flame a bit bigger than previous + more darkkkk liek coffee beans
            {
                f = 1.0F + Medium.random() / 1.0F;
                if (hsb[2] > 0.5D) {
                    hsb[2] = 0.5F;
            ...
            if (embosUndead == 12)/////// polUtility.ys explode outward
            {
                chip = 1;
                ctmag = 2.0F;
                bfase = -7;
            }
            if (embosUndead == 13)/////// dark polUtility.ys
            {
                hsb[1] = 0.2F;
                hsb[2] = 0.4F;
            }
            if (embosUndead == 16)//// flames
            {
                pa = (int) (Medium.random() * n);
                for (pb = (int) (Medium.random() * n); pa == pb; pb = (int) (Medium.random() * n)) {
                }
            }
            if (embosUndead >= 16) ///// flames as well
            {
                byte byte0 = 1;
                byte byte1 = 1;
                int j4;
                ...
                // Flame color. Outer Flame Red Value
                k8 = (int) (220F + 220F * (Medium.snap[0] / 400F));
                if (k8 > 255) {
                    k8 = 255;
                }
                if (k8 < 0) {
                ...
                // Flame color. Outer Flame Green Value
                int i9 = (int) (245F + 245F * (Medium.snap[1] / 300F));
                if (i9 > 255) {
                    i9 = 255;
                }
                if (i9 < 0) {
                ...
                // Flame color. Outer Flame Blue Value
                int k9 = (int) (150F + 150F * (Medium.snap[2] / 200F));
                if (k9 > 255) {
                    k9 = 255;
                }
                if (k9 < 0) {
                ...
                //180, 255, 99 INNER
                // Flame color. Inner Flame Red Value
                k8 = (int) (180F + 180F * (Medium.snap[0] / 400F));
                if (k8 > 255) {
                    k8 = 255;
                }
                if (k8 < 0) {
                ...
                // Flame color. Inner Flame Green Value
                i9 = (int) (255F + 255F * (Medium.snap[1] / 300F));
                if (i9 > 255) {
                    i9 = 255;
                }
                if (i9 < 0) {
                ...
                // Flame color. Inner Flame Blue Value
                k9 = (int) (99F + 99F * (Medium.snap[2] / 200F));
                if (k9 > 255) {
                    k9 = 255;
                }
                if (k9 < 0) {
        ...
        /**
         * This makes the wheels rotate
         * I might come back here if this needs changing
         */
        ...
        if (flag2) {
            ...
            if (!flag) { // Line rendering, come back here for other effects (glitch)
                if (flx == 0) {
                    if (!noOutline) {
                        l11 = 0;
                        j13 = 0;
    ...
    public void rot(int xzAngle) {
        Utility.rot(ox, oz, wx, wz, xzAngle, n); // horizontal spin around center
    }
